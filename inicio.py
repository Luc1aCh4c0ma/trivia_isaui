...
class TriviaGame:
    ...
    def mostrar_formulario_usuario(self):
        ...
        self.formulario_window.config (bg= "black")


        # Etiqueta y campo de entrada para el nombre
        tk.Label(self.formulario_window, text="Nombre de Usuario:", wraplength=800, font=("Arial", 20), bg= "black", fg= "white").pack(padx=10, pady=50)
        ...
        tk.Label(self.formulario_window, text="Red Social:", wraplength=800, font=("Arial", 20),  bg= "black", fg= "white").pack(padx=10, pady=50)
        ...
        tk.Button(self.formulario_window, text="Iniciar Juego", wraplength=800, font=("Arial", 30), borderwidth= 10 , bg= "yellow", fg= "black", command=self.iniciar_juego_desde_formulario).pack(padx=10, pady=50)
    ...
    # Obtener el nombre y la red social ingresados por el usuario
        ...
        # Si no se ingresaron datos, puedes mostrar un mensaje de error o manejarlo como desees
            tk.messagebox.showerror("Error", "Debes ingresar tu nombre y red social para jugar.")
    ...
    def mostrar_pantalla_inicio(self, nombre_usuario, red_social):
        ...
        self.frame_inicio.configure(bg="black")

        self.mi_fuente = font.Font(family="Helvetica", size=50, weight="bold", slant="italic")
        self.etiqueta_bienvenida = tk.Label(self.frame_inicio, text="¡Bienvenido a la Trivia ISAUI!", font=self.mi_fuente, bg="black")
        self.etiqueta_bienvenida.pack(padx=20, pady=200)

        # Cargar la imagen del botón "Play"
        img_play = Image.open("play_button.png")  
        img_play = img_play.resize((250, 150))  # Ajusta el tamaño de la imagen
        img_play = ImageTk.PhotoImage(img_play)

        # Crear un botón personalizado con la imagen
        boton_play = tk.Button(self.frame_inicio, image=img_play, command=self.iniciar_juego, bg="black", borderwidth= 10)
        ...
        # Cambiar el color del texto en intervalos regulares
        self.colores = ['red', 'green', 'blue', 'purple', 'orange', 'white']
    ...
    def iniciar_juego(self):
        ...
        self.pregunta_label = tk.Label(self.root, text="", wraplength=800, font=("Arial", 20), borderwidth= 10 , bg= "black", fg= "white")
        ...
        self.feedback_label = tk.Label(self.root, text="", font=("Arial", 16), fg="green",bg= "black")
        self.feedback_label.pack(pady=20)

        # Etiqueta de tiempo
        self.tiempo_label = tk.Label(self.root, text="Tiempo: 0 segundos", font=("Arial", 16), bg= "black", fg= "white")
        ...
        img = Image.open("door_icon.png")  # Reemplaza "door_icon.png" con el nombre de tu archivo de imagen
